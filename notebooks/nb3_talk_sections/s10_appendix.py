# Talk appendix — reference material moved out of the talk body. Every code cell
# reads the artifacts of record; text blocks are copied from the scientific
# notebook (stage3_presentation.ipynb) with cross-references renumbered to A.x.
...
CELLS = [
    ...
    ("markdown", A3_HEAD),
    ("code", A3_MAIN_CODE),
    ("markdown", A3_LAMBDA_HEAD),
    ("code", A3_LAMBDA_CODE),
    ("markdown", A3_SWEEP_HEAD),
    ("code", A3_SWEEP_CODE),
    ("markdown", A4_HEAD),
    ("code", A4_CODE),
    ("markdown", A5_HEAD),
    ("code", A5_CURVES_CODE),
    ("markdown", A5_DIAG_TEXT),
    ("code", A5_DIAG_CODE),
    ("markdown", A6_HEAD),
    ("code", A6_CODE),
    ("markdown", A7_HEAD),
